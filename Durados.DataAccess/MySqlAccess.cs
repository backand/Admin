...
namespace Durados.DataAccess
{
    public class MySqlAccess : SqlAccess
    {
        ...
        {
            return (useSSH ? "server=localhost;database={1};User Id={2};password={3}" : "server={0};database={1};User Id={2};password={3}") + ";port={4};convert zero datetime=True;default command timeout=90;Connection Timeout=60;CharSet=utf8;";
        }
