...
<div id="<%=guid %>ajaxDiv" class="ajaxDiv" ajaxdiv="ajaxDiv" guid="<%=guid %>" d_MainPage="<%=mainPage %>" d_domain="<%=Durados.Web.Mvc.Maps.Host %>"  onmousedown="Durados.FieldEditor.MouseDown(event, this)">
