...
type ..\Content\styles.css ..\Content\SpryValidation.min.css space.txt ..\Content\jquery.toChecklist.min.css space.txt ..\Content\Stylesheet.min.css space.txt ..\Content\gray.min.css space.txt ..\Content\ddsmoothmenu.min.css space.txt ..\Content\ui.dropdownchecklist.standalone.min.css space.txt ..\Content\ui.dropdownchecklist.themeroller.min.css space.txt ..\Content\jquery.contextMenu.min.css space.txt ..\Content\anythingslider.min.css space.txt ..\Content\spectrum.min.css > ..\Content\general.min.1.0.0.css
