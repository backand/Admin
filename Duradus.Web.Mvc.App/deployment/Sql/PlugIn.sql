...
CREATE TABLE [dbo].[durados_PlugInUser](
	[PlugInUserId] [nvarchar](250) NOT NULL,
	[PlugInId] [int] NULL,
...
---durados_PlugInRegisteredUser

IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_durados_PlugInRegisteredUser_durados_PlugInUser]') AND parent_object_id = OBJECT_ID(N'[dbo].[durados_PlugInRegisteredUser]'))
ALTER TABLE [dbo].[durados_PlugInRegisteredUser] DROP CONSTRAINT [FK_durados_PlugInRegisteredUser_durados_PlugInUser]
GO

IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_durados_PlugInUser_durados_PlugInUser]') AND parent_object_id = OBJECT_ID(N'[dbo].[durados_PlugInRegisteredUser]'))
ALTER TABLE [dbo].[durados_PlugInRegisteredUser] DROP CONSTRAINT [FK_durados_PlugInUser_durados_PlugInUser]
GO

IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_durados_PlugInUser_durados_User]') AND parent_object_id = OBJECT_ID(N'[dbo].[durados_PlugInRegisteredUser]'))
ALTER TABLE [dbo].[durados_PlugInRegisteredUser] DROP CONSTRAINT [FK_durados_PlugInUser_durados_User]
GO

/****** Object:  Table [dbo].[durados_PlugInRegisteredUser]    Script Date: 05/15/2013 16:39:38 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[durados_PlugInRegisteredUser]') AND type in (N'U'))
DROP TABLE [dbo].[durados_PlugInRegisteredUser]
GO

/****** Object:  Table [dbo].[durados_PlugInRegisteredUser]    Script Date: 05/15/2013 16:39:42 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[durados_PlugInRegisteredUser](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[PlugInUserId] [nvarchar](250) NOT NULL,
	[PlugInId] [int] NULL,
	[FirstName] [nvarchar](50) NULL,
	...
	[SelectionDate] [datetime] NULL,
	[Selected] [bit] NULL,
 CONSTRAINT [PK_durados_PlugInUser_1] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[durados_PlugInRegisteredUser]  WITH CHECK ADD  CONSTRAINT [FK_durados_PlugInRegisteredUser_durados_PlugInUser] FOREIGN KEY([PlugInUserId])
REFERENCES [dbo].[durados_PlugInUser] ([PlugInUserId])
GO

ALTER TABLE [dbo].[durados_PlugInRegisteredUser] CHECK CONSTRAINT [FK_durados_PlugInRegisteredUser_durados_PlugInUser]
GO

ALTER TABLE [dbo].[durados_PlugInRegisteredUser]  WITH CHECK ADD  CONSTRAINT [FK_durados_PlugInUser_durados_PlugInUser] FOREIGN KEY([PlugInId])
REFERENCES [dbo].[durados_PlugIn] ([Id])
GO

ALTER TABLE [dbo].[durados_PlugInRegisteredUser] CHECK CONSTRAINT [FK_durados_PlugInUser_durados_PlugInUser]
GO

ALTER TABLE [dbo].[durados_PlugInRegisteredUser]  WITH CHECK ADD  CONSTRAINT [FK_durados_PlugInUser_durados_User] FOREIGN KEY([RegisteredUserId])
REFERENCES [dbo].[durados_User] ([ID])
GO

ALTER TABLE [dbo].[durados_PlugInRegisteredUser] CHECK CONSTRAINT [FK_durados_PlugInUser_durados_User]
GO
...
INSERT INTO [dbo].[durados_PlugIn]([Name],[Ordinal]) VALUES ('BackAnd',1)
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[durados_SetCurrentPlugInRegisteredUser] 
	-- Add the parameters for the stored procedure here
	@plugInId int, 
	@PlugInUserId nvarchar(50),
	@RegisteredUserId int = null,
	@LogOff bit = 0
...
BEGIN
    ...
    update durados_PlugInRegisteredUser
	set Selected = 0
	where PlugInUserId = @PlugInUserId

	if @Logoff = 0 and @RegisteredUserId is not null
	begin
		if exists(select * from durados_PlugInRegisteredUser where PlugInUserId = @PlugInUserId and RegisteredUserId = @RegisteredUserId)
		begin
			update durados_PlugInRegisteredUser
			set SelectionDate = @now,
			Selected = 1
			where PlugInUserId = @PlugInUserId and RegisteredUserId = @RegisteredUserId
		end
		else
		begin
			insert into durados_PlugInRegisteredUser (PlugInUserId, PlugInId, RegisteredUserId, SelectionDate, Selected) values (@PlugInUserId, @PlugInId, @RegisteredUserId, @now, 1)
		end
	end
	commit tran a
END
...
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_durados_PlugInSite_durados_Plan]') AND parent_object_id = OBJECT_ID(N'[dbo].[durados_PlugInSite]'))
ALTER TABLE [dbo].[durados_PlugInSite] DROP CONSTRAINT [FK_durados_PlugInSite_durados_Plan]
GO


/****** Object:  Table [dbo].[durados_PlugInSite]    Script Date: 05/21/2013 07:28:41 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[durados_PlugInSite]') AND type in (N'U'))
DROP TABLE [dbo].[durados_PlugInSite]
GO
...
CREATE TABLE [dbo].[durados_PlugInSite](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[SiteId] [nvarchar](250) NULL,
	[PlanId] [int] NULL,
 CONSTRAINT [PK_durados_PlugInSitePlan] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[durados_PlugInSite]  WITH CHECK ADD  CONSTRAINT [FK_durados_PlugInSite_durados_Plan] FOREIGN KEY([PlanId])
REFERENCES [dbo].[durados_Plan] ([Id])
GO

ALTER TABLE [dbo].[durados_PlugInSite] CHECK CONSTRAINT [FK_durados_PlugInSite_durados_Plan]
GO


IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_durados_PlugInSiteApp_durados_App]') AND parent_object_id = OBJECT_ID(N'[dbo].[durados_PlugInSiteApp]'))
ALTER TABLE [dbo].[durados_PlugInSiteApp] DROP CONSTRAINT [FK_durados_PlugInSiteApp_durados_App]
GO

IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_durados_PlugInSiteApp_durados_PlugInSite]') AND parent_object_id = OBJECT_ID(N'[dbo].[durados_PlugInSiteApp]'))
ALTER TABLE [dbo].[durados_PlugInSiteApp] DROP CONSTRAINT [FK_durados_PlugInSiteApp_durados_PlugInSite]
GO


/****** Object:  Table [dbo].[durados_PlugInSiteApp]    Script Date: 05/21/2013 07:29:00 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[durados_PlugInSiteApp]') AND type in (N'U'))
DROP TABLE [dbo].[durados_PlugInSiteApp]
GO
...
CREATE TABLE [dbo].[durados_PlugInSiteApp](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[PlugInSiteId] [int] NULL,
	[AppId] [int] NULL,
 CONSTRAINT [PK_durados_PlugInSiteApp] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[durados_PlugInSiteApp]  WITH CHECK ADD  CONSTRAINT [FK_durados_PlugInSiteApp_durados_App] FOREIGN KEY([AppId])
REFERENCES [dbo].[durados_App] ([Id])
GO

ALTER TABLE [dbo].[durados_PlugInSiteApp] CHECK CONSTRAINT [FK_durados_PlugInSiteApp_durados_App]
GO

ALTER TABLE [dbo].[durados_PlugInSiteApp]  WITH CHECK ADD  CONSTRAINT [FK_durados_PlugInSiteApp_durados_PlugInSite] FOREIGN KEY([PlugInSiteId])
REFERENCES [dbo].[durados_PlugInSite] ([Id])
GO

ALTER TABLE [dbo].[durados_PlugInSiteApp] CHECK CONSTRAINT [FK_durados_PlugInSiteApp_durados_PlugInSite]
GO
