	...
	var get = {
		...
		* Build: http://www.modernizr.com/download/#-prefixed-testprop-testallprops-domprefixes*/
		...
		defaultPreloader: function(prependTo, transitions, prefix){
			...
			$(prependTo).prepend('<div class="sequence-preloader"><div class="preloading"><img src="website/images/sequence-preloader.png" alt="Sequence is loading, please wait..." />    <img src="website/images/sequence-preloader.png" alt="Sequence is loading, please wait..." />    <img src="website/images/sequence-preloader.png" alt="Sequence is loading, please wait..." /></div></div>');
		}
	},
