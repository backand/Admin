...
;(function($, win, doc) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.setDimensions = function(){
			...
			base.width = base.$el.width();// || base.$el.parents('.slider-container:first').width();
			...
			var w, h, c, t, edge = 0,
				...
				pw = (o.showMultiple > 1) ? base.width || base.$window.width()/o.showMultiple || base.$window.parent().parent().width()/o.showMultiple : base.$window.width(),
				winw = base.$win.width();
			if (o.expand){
			...
			base.$items.each(function(i){
				...
				if (o.resizeContents){
					...
					w = t.width() || base.width;// || t.children('div:first').width(); // if image hasn't finished loading, width will be zero, so set it to base width instead
					if (c.length === 1 && (w >= winw || w == 0)){
