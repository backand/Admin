...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="main">
        <tr>
           <td valign="top" style="">
               <%  Html.RenderPartial("~/Views/Shared/Controls/AdminMenu.ascx", new Durados.Web.Mvc.App.Views.Shared.Controls.AdminMenuModel() { Views = Durados.Web.Mvc.Map.Database.GetVisibleViews(), Expand = true, MenuName = Durados.Web.Localization.Localizer.Translate("Menu_Views") }); %>
               
               <br />
               <% if (!SecurityHelper.IsDenied(view.Database.DenyConfigConfigRoles)) %>
               <%  Html.RenderPartial("~/Views/Shared/Controls/AdminMenu.ascx", new Durados.Web.Mvc.App.Views.Shared.Controls.AdminMenuModel() { Views = Durados.Web.Mvc.Map.GetConfigDatabase().GetVisibleViews(), Expand = view is Durados.Config.IConfigView, MenuName = Durados.Web.Localization.Localizer.Translate("Menu_Admin") }); %>
               
               <br />
               <% if (!SecurityHelper.IsDenied(view.Database.DenyLocalizationConfigRoles) && Durados.Web.Mvc.Map.Database.Localization != null) %>
               <%  Html.RenderPartial("~/Views/Shared/Controls/AdminMenu.ascx", new Durados.Web.Mvc.App.Views.Shared.Controls.AdminMenuModel() { Views = Durados.Web.Mvc.Map.GetLocalizationDatabase().GetVisibleViews(), Expand = view is Durados.Config.IConfigDatabase, MenuName = Durados.Web.Localization.Localizer.Translate("Menu_Localization") }); %>
            </td>        
    ...
    <div style="display:none" id="DataRowCreate" >
        <ul>
            <li><a href="#c_tabs-1"><span>Tab 1</span></a></li>
            <li><a href="#c_tabs-2"><span>Tab 2</span></a></li>
        </ul>    
    ...
    <div style="display:none" id="DataRowEdit" >
        <ul>
            <li><a href="#e_tabs-1"><span>Tab 1</span></a></li>
            <li><a href="#e_tabs-2"><span>Tab 2</span></a></li>
        </ul>    
...
//    });
    ...
    //init tabs
    $('#DataRowCreate').tabs(); // first tab selected
    $('#DataRowEdit').tabs(); // first tab selected
    ...
    $(document).ready(function() {
        ...
        $("#DataRowInlineAdding").dialog({
            ...
            width: getDialogWidth(gColCount, 160),
            height: getDialogHeight(gColCount, gCreateRowCount, 30),
            position: 'center'
        });
    }); 
    ...
    AddDialog.Open = function(pk) {
        ...
        AddDialog.Reset();
        //alert($("#DataRowCreate")[0].scrollWidth);
        //aaa;
        //$("#DataRowCreate").dialog('option','width',getDialogWidth(gColCount,300));
        $("#DataRowCreate").dialog('option','width','70%');
    ...
    EditDialog.Open = function(pk) {
        ...
        $("#DataRowEdit").dialog('option','width','70%');
...
//Inline Adding
    ...
    CreateDialog.Open = function(viewName, viewDisplay, type, id, createUrl) {
        ...
        dialog.dialog('option','width',dialog.scrollWidth);
